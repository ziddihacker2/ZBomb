...
def start(target, counter, delay, ch, cc):
    ...
    while success < (int(bombs)):
        ...
        try:
            ...
            if cc == "91":
                print('Sorry All APIs Have Expired Please Update ZBomb')
                ...
                if success > 0:
                    ...
                    print(
                        '\t\tPlease Send A Mail To ziddihacker2@gmail.com To Let Us Know...')
                    input('Press Enter To Exit...')
                    exit()
        print("==================================================================")
...
if nm == 0:
    ...
    if nt <= 0 or nt >= 50:
        print('\tZBomb Shows Better Result in 10 to 50 Threads\n\t\tStill Continuing....')
    ...
    print("              This Bomber Was edited BY H4CK3R credits to owner@speedx !! ")
    print("==================================================================")
